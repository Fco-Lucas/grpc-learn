...
const file_echo_v1_echo_proto_rawDesc = "" +
	...
	"\vEchoService\x129\n" +
	"\bSayHello\x12\x15.echo.v1.HelloRequest\x1a\x16.echo.v1.HelloResponseB4Z2github.com/Fco-Lucas/grpc-learn/gen/echo/v1;echov1b\x06proto3"
...
var file_echo_v1_echo_proto_goTypes = []any{
	...
	(*HelloResponse)(nil), // 1: echo.v1.HelloResponse
}
var file_echo_v1_echo_proto_depIdxs = []int32{
	0, // 0: echo.v1.EchoService.SayHello:input_type -> echo.v1.HelloRequest
	1, // 1: echo.v1.EchoService.SayHello:output_type -> echo.v1.HelloResponse
